...
const vars = extractRootVars([
  readFileSync(new URL('web_src/css/themes/theme-gitfx-light.css', import.meta.url), 'utf8'),
  readFileSync(new URL('web_src/css/themes/theme-gitfx-dark.css', import.meta.url), 'utf8'),
].join('\n'));
