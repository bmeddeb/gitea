...
func TestRepoCommitsWithStatus(t *testing.T) {
	...
	t.Run("error", func(t *testing.T) { testRefMaster(t, "error", "gitfx-exclamation", "tw-text-red") })
	t.Run("failure", func(t *testing.T) { testRefMaster(t, "failure", "octicon-x", "tw-text-red") })
	t.Run("warning", func(t *testing.T) { testRefMaster(t, "warning", "gitfx-exclamation", "tw-text-yellow") })
