	...
	cases := []struct {
		...
		// case 0
		{
			args: []string{
				...
				"--group-team-map", `{"cn=my-group,cn=groups,dc=example,dc=org": {"MyGitFXOrganization": ["MyGitFXTeam1", "MyGitFXTeam2"]}}`,
			...
			source: &auth.Source{
				...
				Cfg: &ldap.Source{
					...
					GroupTeamMap:          `{"cn=my-group,cn=groups,dc=example,dc=org": {"MyGitFXOrganization": ["MyGitFXTeam1", "MyGitFXTeam2"]}}`,
